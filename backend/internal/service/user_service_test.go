...
func TestUserService(t *testing.T) {
	...
	t.Run("BulkCourseAccess", func(t *testing.T) {
		...
		_, _ = courseSvc.CreateCourse("Course1", []model.Grade{model.Grade("3")}, subjects["math"].ID, model.ContentLearning, "", nil, "", "")
		_, _ = courseSvc.CreateCourse("Course2", []model.Grade{model.Grade("4")}, subjects["physics"].ID, model.ContentLearning, "", nil, "", "")
