...
func TestCourseService(t *testing.T) {
	...
	t.Run("CreateCourseSingleGrade", func(t *testing.T) {
		course, err := svc.CreateCourse("Math Grade 3", []model.Grade{model.Grade("3")}, subjects["math"].ID, model.ContentLearning, "http://cover.url", nil, "", "")
		if err != nil {
	...
	t.Run("CreateCourseMultiGrade", func(t *testing.T) {
		course, err := svc.CreateCourse("Science 3-4", []model.Grade{model.Grade("3"), model.Grade("4")}, subjects["physics"].ID, model.ContentLearning, "http://cover.url", nil, "", "")
		if err != nil {
	...
	t.Run("CreateCourseInvalidGrade", func(t *testing.T) {
		_, err := svc.CreateCourse("Invalid", []model.Grade{model.Grade("12")}, subjects["math"].ID, model.ContentLearning, "", nil, "", "")
		if err == nil {
			t.Error("Expected error creating course with invalid grade, got nil")
		}

		_, err = svc.CreateCourse("Invalid Parts", []model.Grade{model.Grade("3"), model.Grade("invalid")}, subjects["math"].ID, model.ContentLearning, "", nil, "", "")
		if err == nil {
	...
	t.Run("UpdateCourse", func(t *testing.T) {
		course, err := svc.CreateCourse("Physics 7", []model.Grade{model.Grade("7")}, subjects["physics"].ID, model.ContentLearning, "", nil, "", "")
		if err != nil {
			t.Fatalf("Failed to create course: %v", err)
		}

		updated, err := svc.UpdateCourse(course.ID, "Physics 7-8", []model.Grade{model.Grade("7"), model.Grade("8")}, subjects["physics"].ID, model.ContentLearning, "http://new.cover", nil, "", "")
		if err != nil {
	...
	t.Run("FilterCoursesByGrade", func(t *testing.T) {
		...
		// Create test courses
		_, _ = svc.CreateCourse("Course Grade 3 and 4", []model.Grade{model.Grade("3"), model.Grade("4")}, subjects["math"].ID, model.ContentLearning, "", nil, "", "")
		_, _ = svc.CreateCourse("Course Grade 4 and 5", []model.Grade{model.Grade("4"), model.Grade("5")}, subjects["math"].ID, model.ContentLearning, "", nil, "", "")
		_, _ = svc.CreateCourse("Course Universal", []model.Grade{model.GradeUniversal}, subjects["math"].ID, model.ContentLearning, "", nil, "", "")
		_, _ = svc.CreateCourse("Course Grade 6 Only", []model.Grade{model.Grade("6")}, subjects["math"].ID, model.ContentLearning, "", nil, "", "")
