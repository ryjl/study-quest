// CourseWorkbench — 课程级 AI 工作台。"对象即导航"重构的核心载体之一:
// 围绕「一门课」把它的所有 AI 事务聚合到一个页面,而不是散在多个按功能类型
// 切的 tab 里(旧 AIConsole 的 regen/glossary 等各自独立,任务流跨 tab 断裂)。
//
// 5 个 tab(对象内部切"切面",符合专业后台"顶部 tab ≤5"规则):
//   - 概览:这门课的 AI 状态全景(总结/作业/术语待审/失败任务)
//   - 内容:生成/删除 总结+作业+润色(原 CourseRegenColumn)
//   - Prompt:这门课的 prompt 覆盖 + 即时预览(修复旧"跳外部页面预览"的断裂)
//   - 术语:这门课的术语候选 + 接受后一键润色(修复旧"接受完要跨 tab 去应用"的断裂)
//   - 质量:这门课的错题/考试观测 + 行动入口(修复旧"错题本死胡同无行动"的断裂)
//
