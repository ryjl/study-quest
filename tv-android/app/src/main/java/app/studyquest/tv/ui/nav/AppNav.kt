package app.studyquest.tv.ui.nav
...
import app.studyquest.tv.ui.footprint.FootprintScreen
import app.studyquest.tv.ui.home.CourseHallScreen
import app.studyquest.tv.ui.settings.SettingsScreen
 ...
 */
@Composable
fun AppNav(sessionViewModel: app.studyquest.tv.ui.SessionViewModel = hiltViewModel()) {
    ...
    LaunchedEffect(authState) {
        if (authState == app.studyquest.tv.ui.AuthState.Authenticated &&
            currentRoute == Routes.LOGIN
        ) {
            navController.navigate(Routes.HOME) {
                popUpTo(Routes.LOGIN) { inclusive = true }
            }
        } else if (authState == app.studyquest.tv.ui.AuthState.Unauthenticated &&
    ...
    NavHost(
        ...
        composable(Routes.LOGIN) {
            app.studyquest.tv.ui.auth.LoginScreen(
        ...
        composable(
            ...
            app.studyquest.tv.ui.detail.CourseDetailScreen(
                courseId = courseId,
        ...
        composable(
            ...
            app.studyquest.tv.ui.player.VideoPlayerScreen(
                episodeId = episodeId,
                onBack = { navController.popBackStack() },
            )
        }
