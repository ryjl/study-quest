...
///
/// grade 是开放 tag 体系:客户端过滤栏从这个端点动态拉取可用 tag 列表
/// (5 个预设 + admin 已用的自定义 tag),不写死 1-9 年级。
///
/// 后端字段:
...
/// 兜底,保证过滤栏始终可用。
///
/// 没有「成人」(adult) 预设——该词在中文教育语境联想偏向成人教育/夜校,与产品
/// 定位(中小学 + 大学/进修)不搭;用「大学」(college) + 「其它」(other) 代替,
/// "其它" 作为进修/职场/考研等不归类人群的兜底。
